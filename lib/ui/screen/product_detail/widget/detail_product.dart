...
import 'package:nws_hieuvm_ecommerce_flutter/ui/screen/product_detail/widget/button.dart';
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextNormal(text: widget.title, textSize: 11),
                    const SizedBox(height: 5),
                    Row(
                      children: [
                        SvgPicture.asset(
                    ...
                    const SizedBox(height: 10),
                    TextNormal(text: widget.description, textSize: 11),
                    const Spacer(),
                    const TextNormal(
                      text: 'Total Price',
                      textSize: 9,
      ...
      child: Row(
        ...
        children: List.generate(
          sizes.length,
              (indexSize) => InkWell(
            onTap: () =>
                _productDetailCubit.onChangedSize(indexSize),
            child: Padding(
              padding: const EdgeInsets.all(1.0),
              child: itemSize(indexSize, widget.curlIndexSize,
                  context, sizes),
            ),
          ),
        ),
      ...
      child: Column(
        ...
        children: List.generate(
          colors.length,
              (index) => InkWell(
            onTap: () =>
                _productDetailCubit.onChangedColors(index),
            child: Padding(
              padding: const EdgeInsets.all(1.0),
              child: itemColor(index, widget.curlIndexColor,
                  context, colors),
            ),
          ),
        ),
