                ...
                SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                          alignment: Alignment.topLeft,
                          child: const TextBold(text: 'Notification', textSize: 18)),
                              ...
                              child: ListView.separated(
                                ...
                                itemBuilder: (context, index) {
                                  return ItemNotification(
                                    ...
                                    nameProduct: state.listNotification?[index].nameProduct ?? '',
                                    imageProduct: state.listNotification?[index].imageProduct ?? '',
                                    timeOrder: '11',
                                  );
                                },
                                separatorBuilder:
